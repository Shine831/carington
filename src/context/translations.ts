export const translations = {
  fr: {
    ...
    about: {
      ...
      desc: "E-JARNAULD SOFT est un cabinet panafricain spécialisé dans les solutions critiques d'infrastructure IT, de cybersécurité et de réseaux intelligents. Nous transformons les défis complexes en opportunités technologiques.",
    ...
    contact: {
      ...
      title_part2: "Avenir.",
      desc: "Nos experts sont basés à NDOGPASSI, Douala. Réponse moyenne : 1h45min.",
      info_title: "Coordonnées",
      form_title: "Envoyer un message",
      items: {
        hq: "Siège Social",
        hq_val: "Marché NDOGPASSI\nDouala, Cameroun",
        std: "Standard",
  ...
  en: {
    ...
    about: {
        ...
        desc: "E-JARNAULD SOFT is a pan-African firm specializing in critical IT infrastructure, cybersecurity and smart network solutions. We transform complex challenges into technological opportunities.",
    ...
    contact: {
        ...
        title_part2: "Future.",
        desc: "Our experts are based in NDOGPASSI, Douala. Average response: 1h45min.",
        info_title: "Contact details",
        form_title: "Send a message",
        items: {
            hq: "Head Office",
            hq_val: "NDOGPASSI Market\nDouala, Cameroon",
            std: "Standard",
