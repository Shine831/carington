export const translations = {
  fr: {
    ...
    hero: {
      ...
      desc: "E-JARNAULD SOFT fusionne l'expertise technique et la vision stratégique pour bâtir les infrastructures numériques les plus résilientes du Cameroun.",
    ...
    services: {
      ...
      cyber: {
        ...
        desc: "Vérification complète de vos défenses numériques et tests d'intrusion critiques."
      },
      infra: {
        tag: "Infrastructure",
        title: "Réseau & Câblage",
        desc: "Câblage structuré et VPN."
      },
      it: {
        tag: "Maintenance",
        title: "Infogérance IT",
        desc: "Gestion de parcs serveurs."
      },
      cloud: {
        tag: "Cloud",
        title: "Cloud Solutions",
        desc: "Migration Azure/AWS."
      }
    },
    why: {
      tag: "Engagement 2026",
    ...
    contact: {
      tag: "Support & Partenariat",
      badge: "Équipe Dédiée",
      title_part1: "Parlons de votre",
      title_part2: "Avenir.",
      desc: "Nos experts sont basés à Akwa, Douala. Réponse moyenne : 1h45min.",
      info_title: "Coordonnées",
      form_title: "Envoyer un message",
      items: {
        hq: "Siège Social",
        hq_val: "Immeuble TechHub, Akwa\nDouala, Cameroun",
        std: "Standard",
        urgency: "Urgence 24/7",
        email: "Email",
        hours: "Horaires",
        hours_val: "Lun-Ven 08h00 – 18h00\nSamedi 09h00 – 13h00"
      },
      form: {
        name: "Nom / Entreprise",
        ...
        subjects: {
          ...
          audit: "Demande d'Audit IT/Cyber",
          other: "Autre"
        },
    ...
    booking: {
      ...
      title_part1: "Planifiez votre",
      title_part2: "Résilience.",
      desc: "Nos ingénieurs analysent votre infrastructure et proposent une stratégie sous 12h.",
      whatsapp: "WhatsApp Direct",
      new_request: "Nouvelle Demande",
      ssl: "SSL Actif",
      step1_title: "Profil Client",
      step1_type: "Type de Structure",
      step1_entity: "Entité / Demandeur",
      step1_email: "Email Professionnel",
      step1_phone: "Téléphone de contact",
      step2_title: "Spécifications Techniques",
      step2_service: "Service Principal",
      step2_budget: "Budget Estimé",
      step2_time: "Délai Souhaité",
      step2_desc: "Description détaillée de votre besoin",
      submit: "Soumettre la Requête",
      terms: "En soumettant, vous acceptez nos Conditions Générales.",
      process_title: "Processus de Validation",
      secure_data: "Données 100% Sécurisées",
      secure_desc: "AES-256 · Hébergement Cameroun",
      steps: [
    ...
    account: {
      tag: "Espace Client",
      title_part1: "Votre interface",
      title_part2: "de gestion IT.",
      desc: "Accédez à votre tableau de bord pour suivre vos projets, contacter nos équipes et gérer vos contrats.",
      secure_badge: "Accès sécurisé 24/7 · Protection des données garantie",
      features: [
        "Suivi de vos demandes en temps réel",
        "Accès à l'historique complet",
        "Connexion prestataires certifiés",
        "Espace dédié pour vos avis"
      ],
      login: {
        title: "Connexion",
        desc: "Entrez vos identifiants pour accéder à votre espace.",
        email: "Adresse Email",
        password: "Mot de Passe",
        forgot: "Oublié ?",
        submit: "Accéder à mon espace",
        footer: "Première visite ? Créez votre compte client.",
    ...
    admin: {
      ...
      modals: {
        ...
        status_will_change: "Le statut passera à ",
        note_sent_client: " Votre note sera transmise au client."
      },
      security: {
        pin_title: "Accès Restreint",
        pin_desc: "Veuillez entrer le Code PIN Maître pour débloquer l'interface d'administration.",
        pin_setup_title: "Initier Code Admin",
        pin_setup_desc: "Afin de protéger l'accès principal, veuillez configurer votre Code PIN.",
        pin_error: "Code Incorrect",
        pin_unlock: "Déverrouiller",
        pin_setup: "Enregistrer mon PIN",
        ...
        confirm_password_change: "Confirmer le changement",
        master_pin: "Code PIN Maître",
        old_pin: "Ancien Code PIN",
        new_pin: "Nouveau Code PIN (6 chiffres)",
        old_password: "Mot de passe actuel",
        new_password: "Nouveau mot de passe (min. 8 caractères)",
        db_title: "Base de données",
        empty_set: "Données Souveraines : Aucun résultat",
        pending_reqs: "requêtes en attente",
        unread_msgs: "messages non lus",
        new_revs: "nouveaux témoignages",
        display_name: "Nom d'affichage",
        save_config: "Sauvegarder Configuration",
        req_details: "Détails de la demande",
        entity_client: "Entité / Client",
        phone: "Téléphone",
        chosen_service: "Service Choisi",
        budget_allotted: "Budget Alloué",
        timeframe: "Délai d'intervention",
        ...
        change_pass_desc: "Confirmez votre identité puis saisissez le nouveau mot de passe.",
        old_password_ph: "Votre mot de passe actuel",
        new_password_ph: "Nouveau mot de passe sécurisé",
        logout_confirm: "Fermer la session administrateur et vous déconnecter ?",
        delete_permanent: "Supprimer définitivement ?",
        delete_review: "Supprimer ce témoignage définitivement ?",
        delete_client: "Supprimer ce compte client définitivement ?",
    ...
    footer: {
      desc: "Cabinet d'ingénierie IT et cybersécurité élite basé à Douala. Nous architecturons la souveraineté.",
      cols: {
        solutions: "Solutions",
        agency: "Agence",
        legal: "Juridique"
  ...
  en: {
    ...
    hero: {
        ...
        desc: "E-JARNAULD SOFT merges technical expertise and strategic vision to build Cameroon's most resilient digital infrastructures.",
    ...
    admin: {
        ...
        modals: {
            ...
            status_will_change: "Status will change to ",
            note_sent_client: " Your note will be sent to the client."
        },
        security: {
            pin_title: "Restricted Access",
            pin_desc: "Please enter the Master PIN Code to unlock the management interface.",
            pin_setup_title: "Initiate Admin Code",
            pin_setup_desc: "To protect main access, please configure your PIN Code.",
            pin_error: "Incorrect Code",
            pin_unlock: "Unlock",
            pin_setup: "Save my PIN",
            ...
            confirm_password_change: "Confirm change",
            master_pin: "Master PIN Code",
            old_pin: "Old PIN Code",
            new_pin: "New PIN Code (6 digits)",
            old_password: "Current password",
            new_password: "New password (min. 8 chars)",
            db_title: "Database",
            empty_set: "Sovereign Data: Empty set",
            pending_reqs: "pending requests",
            unread_msgs: "unread messages",
            new_revs: "new testimonials",
            display_name: "Display Name",
            save_config: "Save Configuration",
            req_details: "Request Details",
            entity_client: "Entity / Client",
            phone: "Phone",
            chosen_service: "Chosen Service",
            budget_allotted: "Allocated Budget",
            ...
            change_pass_desc: "Confirm your identity then enter your new password.",
            old_password_ph: "Your current password",
            new_password_ph: "New secure password",
            logout_confirm: "Close admin session and log out?",
            delete_permanent: "Delete permanently?",
            delete_review: "Delete this review permanently?",
            delete_client: "Delete this client account permanently?",
